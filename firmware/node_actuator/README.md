...
| `multiplexed` | `src/multiplexed/` | `node_multiplexed` | Up to 12 chambers, muxed valves/sensors (2× PCA9685 + 74HC4067), shared pump banks (no reservoir tanks in the current build), 4 LED rings |
